      ...
      items: [
        ...
        },
        {
          ...
          subItems: [
            ...
            { name: "A1.01 Architectural Floor Plan", path: "a101-architectural-floor-plan" },
            {name: "A1.02 Reflected Ceiling Plan", path: "a102-reflected-ceiling-plan" },
            {name: "A1.03-Equipment Floor Plan", path: "a103-equipment-floor-plan" },
            {name:"A1.04 Life Safety Plan", path: "a104-life-safety-plan" },
            {name: "A1.05 Architectural Roof Plan",path:"a105-architectural-roof-plan" },
            {name: "A0.03 Development Site Plan", path: "a003-development-site-plan" },
            {name: "A0.04 Fire Access Lane Layout", path: "a004-fire-access-lane-layout" },
